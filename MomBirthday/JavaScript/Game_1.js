...
function Win_Button(){
    ...
    context.fillText("NextLevel", Canvas_width / 2, Canvas_height / 2 + 10);
}
...
function EventDown(e){
    ...
    if(Play_Continue_GO == 2){ // when player is playing
        ...
        var y = Canvas_height / 2 - 50;
        if(mouse.x >= x && mouse.x <= x + 200 && mouse.y >= y && mouse.y <= y + 100){
            document.location.href = './54adac2cc98e6078e9f43eb041af8884d414e3c920300a0d69d1e73654c0fb54.html';
        }
